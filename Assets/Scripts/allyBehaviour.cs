...
public class allyBehaviour : MonoBehaviour
{
    ...
    {
        if (other.gameObject.tag == "Ally" && other.gameObject.transform.position.x < transform.position.x)
        {
            transform.rotation *= Quaternion.Euler(0, 0, -0.5f);
        }
        else if (other.gameObject.tag == "Ally" && other.gameObject.transform.position.x > transform.position.x)
        {
            transform.rotation *= Quaternion.Euler(0, 0, 0.5f);
        }
    }
